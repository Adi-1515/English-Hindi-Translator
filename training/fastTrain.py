...
# Configuration
parser = argparse.ArgumentParser(description="Train translation model (fast).")
...
# Changed the save path to match the efficiently requested output directory
